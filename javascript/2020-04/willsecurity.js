let parkingGate = {
    ...
    patrkeyFobScannedOutofParkinglotonNameScannedOutOfParkingLot: [],
    timePatronScannedOutOfParkingLot: [],
    inScan: function () {
      if (this.keyFobScannedInParkinglot.includes(this.currentKeyFobScanned)) {
       ; console.log(
          `:::WARNING ${this.currentPatronNameScanned} IS ALREADY IN THE PARKING GARAGE!:::` );
      } else {
        ...
        console.log(
          `   ${this.patronNameScannedInParkingLot}: ${this.keyFobScannedInParkinglot}`
        );
      }
    },
    outScan: function () {
        if (this.keyFobScannedOutParkinglot.includes(this.currentKeyFobScanned)) {
        console.log(
          `:::WARNING ${this.currentPatronNameScanned} HAS ALREADY LEFT THE PARKING GARAGE!:::`
        );
      } else {
        this.keyFobScannedOutParkinglot.push(
          this.keyFobScannedInParkinglot
            .splice(
              this.keyFobScannedInParkinglot.indexOf(this.currentKeyFobScanned),
              1
            )
            .pop()
        );
        this.patronNameScannedOutOfParkingLot.push(
          this.patronNameScannedInParkingLot
            .splice(
              this.patronNameScannedInParkingLot.indexOf(
                this.currentPatronNameScanned
              ),
              1
            )
            .pop()
        );
        this.timePatronScannedOutOfParkingLot.push(
          this.timePatronScannedInParkingLot
            .splice(
              this.timePatronScannedInParkingLot.indexOf(
                this.currentTimeKeyFobScanned
              ),
              1
            )
            .pop()
        ...
        console.log(`${this.timePatronScannedOutOfParkingLot}`);
      }
    },
  };
